...
upper_body['t-shirt'] = fuzz.trimf(upper_body.universe, [0, 1, 2])
upper_body['shirt'] = fuzz.trimf(upper_body.universe, [1, 2, 3])
upper_body['polo'] = fuzz.trimf(upper_body.universe, [2, 3, 4])
upper_body['sweater'] = fuzz.trimf(upper_body.universe, [3, 4, 5])
upper_body['jacket'] = fuzz.trimf(upper_body.universe, [4, 5, 6])
upper_body['coat'] = fuzz.trimf(upper_body.universe, [5, 6, 7])
upper_body['blazer'] = fuzz.trimf(upper_body.universe, [6, 7, 8])
upper_body['dress'] = fuzz.trimf(upper_body.universe, [7, 8, 9])

# Membership functions for lower_body
lower_body['trousers'] = fuzz.trimf(lower_body.universe, [0, 1, 2])
lower_body['shorts'] = fuzz.trimf(lower_body.universe, [1, 2, 3])
lower_body['skirt'] = fuzz.trimf(lower_body.universe, [2, 3, 4])
lower_body['jeans'] = fuzz.trimf(lower_body.universe, [3, 4, 5])
lower_body['leggings'] = fuzz.trimf(lower_body.universe, [4, 5, 6])
lower_body['pants'] = fuzz.trimf(lower_body.universe, [5, 6, 7])
